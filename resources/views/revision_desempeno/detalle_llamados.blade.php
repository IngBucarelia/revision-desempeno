...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="container">
                <h3>Llamados de Atención Para : <br> cedula: {{ $cedula }}</h3>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Fecha Notificación</th>
                            <th>Asunto</th>
                            <th>Descripción Falta</th>
                            <th>Observaciones</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('llamados_atencion.detalle', $item->id) }}" class="btn btn-info">👁️ Ver Detalle</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
