...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" >
            <div class="container">
                <h4 class="titulo_formulario">Revisiones de Desempeño asignadas a: <br> Seguridad y Salud en el Trabajo</h4>
                            ...
                            <tbody>
                                @forelse ($revisiones as $rev)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('revision_desempeno.edit.sst', $rev->id) }}" class="btn btn-primary btn-sm">👁️ Revisar</a>
                                        </td>
                                    </tr>
                                @empty
