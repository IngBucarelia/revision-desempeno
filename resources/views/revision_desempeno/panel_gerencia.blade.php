...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" >
            <div class="container">
                <h4 class="titulo_formulario">Revisión de Desempeño asignadas a: <br> Gerencia</h4>
                            ...
                            <tbody>
                                @forelse ($revisiones as $rev)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('revision_desempeno.edit.gerencia', $rev->id) }}" class="btn btn-primary btn-sm">👁️ Revisar</a>
                                        </td>
                                    </tr>
                                @empty
