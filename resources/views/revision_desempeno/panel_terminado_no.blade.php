...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" >
            <div class="container">
                <h4 class="titulo_formulario">Revisiones de Desempeño: <br> Ya Revisados y Terminados - No Cumple</h4>
                    ...
                    <tbody>
                        @forelse ($revisiones as $rev)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('revision_desempeno.detalle', $rev->id) }}" class="btn btn-primary btn-sm">👁️ Ver Detalle</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5">No hay revisiones asignadas.</td>
                            </tr>
                        @endforelse
                    </tbody>
                 </table>
