    ...
    <div class="contenedor-principal">
        ...
        <form method="POST" action="{{ route('novedades_contrato.store') }}">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-4">
                    <input type="date"  value="{{$novedad->fecha_reporte}}" name="fecha_reporte" class="form-control" required>
                </div>
            </div>
           ...
           <div class="mb-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" value="{{$novedad->nombre_trabajador}}" name="nombre_trabajador" class="form-control" required></td>
                        <td><input type="text" value="{{$novedad->codigo_trabajador}}" name="codigo_trabajador" class="form-control" required></td>
                        <td><input type="date" value="{{$novedad->fecha_novedad}}" name="fecha_novedad" class="form-control" required></td>
                        <td><input type="text" value="{{$novedad->tiempo_prorroga}}" name="tiempo_prorroga" class="form-control"></td>
                        <td><input type="text" value="{{$novedad->tipo_contrato}}" name="tipo_contrato" class="form-control" required></td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="mb-3">
                ...
                <textarea name="observaciones" class="form-control" rows="3">{{$novedad->observaciones}}</textarea>
            </div>

            <div class="row mb-4">
                <div class="col-md-6">
                    <label>Diligenciado por:</label>
                    <input type="text" value="{{$novedad->diligenciado_por}}" name="diligenciado_por" class="form-control">
                </div>
                <div class="col-md-6">
                    <label>Autorizado por:</label>
                    <input type="text" value="{{$novedad->autorizado_por}}" name="autorizado_por" class="form-control">
                </div>
            </div>
