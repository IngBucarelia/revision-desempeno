<x-app-layout>
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">
                <h2 class="titulo_formulario">Faltas Disciplinarias Desición Tomada </h2><br>  
               ...
               <table class="table table-hover table-striped text-center mx-auto">
                    <thead>
                        <tr>
                            ...
                            <th>Fecha Falta</th>
                            <th>Tipo Falta</th>
                            <th><strong>Medidas Tomadas</strong></th> {{-- NUEVA COLUMNA --}}
                            <th>Acciones</th>
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->role_id == 1  || auth()->user()->role_id == 2)
                                        <a href="{{ route('faltas_disciplinarias.desicionfinal', $falta->id) }}" class="btn btn-warning btn-sm mb-1">👁️ Ver Detalle</a>
                                    @endif
