    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px"> 
            <div class="contenido">    
                ...
                <h2 class="titulo_formulario"> Registro de  Falta Disciplinaria Desición Final </h2><br>  
                    @csrf
                    @method('PUT')
                ...
                <tr>
                        ...
                        @endif
                        <tr>
                            <td colspan="5" style="text-align: center; background-color: rgba(94, 128, 80, 0.416);">Información de Respuesta a Apelación</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <strong>¿Se Respondió la Apelación?</strong>
                                </td>
                                <td colspan="3">
                                    @if ($proceso->respondio_apelacion == 1)
                                        Sí
                                    @else
                                        No
                                    @endif
                            ...
                            @if ($proceso->respondio_apelacion == 1)
                                <tr>
                                    <td colspan="2">
                                        <strong>Respuesta de Apelación:</strong>
                                    </td>
                                    <td colspan="3">
