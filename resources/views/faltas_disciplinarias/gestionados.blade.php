<x-app-layout>
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">
                <h2 class="titulo_formulario">Faltas Disciplinarias Requeridas en Descargos</h2><br>  
                    ...
                    <tbody id="tablaFaltas">
                        @foreach($faltas as $falta)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('faltas_disciplinarias.fase2', $falta->id) }}" class="btn btn-warning btn-sm mb-1">👁️ Ver</a>
