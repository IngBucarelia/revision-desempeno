<x-app-layout>
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">
                <h2 class="titulo_formulario">Faltas Disciplinarias por Gestionar </h2><br>  
                        ...
                        @foreach($faltas as $falta)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('faltas_disciplinarias.fase0', $falta->id) }}" class="btn btn-warning btn-sm mb-1">👁️ Gestionar</a>
                                     @endif
