    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px"> 
            <div class="contenido">    
                ...
                <h2 class="titulo_formulario"> Registro de  Falta Disciplinaria Apelada</h2><br>  
                <form action="{{ route('faltas_disciplinarias.respuestaapelar', ['faltas_disciplinaria' => $proceso->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                ...
                <tr>
                        ...
                        <tr>
                            <td colspan="5" style="text-align: center; background-color: rgba(94, 128, 80, 0.416);">Información de Apelación</td>
                        </tr>
                        <tr>
                            <td>
                                <strong>¿Hubo Apelación?</strong>
                            </td>
                            <td>
                                @if ($proceso->apelo == 1)
                                    Sí
                        ...
                        @if ($proceso->apelo == 1)
                            <tr>
                                <td>
                                    <strong>Comentarios de Apelación:</strong>
                                </td>
                                <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="d-flex align-items-center mb-3">
                                    <label class="me-3">¿Dar respuesta a apelacio?</label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="respondio_apelacion" id="apelacionSi" value="1">
                                        <label class="form-check-label" for="apelacionSi">Sí</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="respondio_apelacion" id="apelacionNo" value="0" checked>
                                ...
                                <div id="camposApelacion" style="display: none;">
                                    <div class="mb-3">
                                        <label for="comentarioApelacion" class="form-label">Respuesta  de Apelación:</label>
                                        <textarea class="form-control" id="comentarioApelacion" name="respuesta_apelacion" rows="3"></textarea>
                                    </div>
                                </div>
                            </td>
                        </tr>
