...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px"> 
            <div class="contenido">    
                <h2 class="titulo_formulario"> Registro de Descargo a  Falta Disciplinaria</h2><br>  
                <form action="{{ route('faltas_disciplinarias.Updatefase2', ['faltas_disciplinaria' => $proceso->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                ...
                <tr>
                        ...
                        <tr>
                            ...
                            <textarea name="comentarios_descargos" id=""></textarea>
                            </td>
                           
                            <td colspan="2"> <input type="file" name="pdf_descargo" accept="application/pdf"></td>
                        </tr>            
                    </table>
                    <button  type="submit">Registrar Descargo y Proceder</button>
                    </form>
