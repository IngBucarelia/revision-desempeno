<x-app-layout>
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">
                <h2 class="titulo_formulario">Faltas Disciplinarias que Fueron apeladas </h2><br>  
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->role_id == 1  || auth()->user()->role_id == 2)
                                        <a href="{{ route('faltas_disciplinarias.enapelacion', $falta->id) }}" class="btn btn-warning btn-sm mb-1">👁️ Ver Detalle</a>
                                    @endif
