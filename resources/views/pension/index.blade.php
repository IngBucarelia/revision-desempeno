...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">    
                <h2 class="titulo_formulario">Administrar Fondo de Pensiones</h2><br>
                ...
                <table class="table table-hover table-striped text-center mx-auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm" style="margin-bottom: 5px !important;"><a href="{{ route('pension.edit', $pension) }}">Editar</a></button><br>
                            <form action="{{ route('pension.destroy', $pension) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    @endforeach
                </table><br><br><button><a href="{{ route('pension.create') }}">Crear pension</a></button>
