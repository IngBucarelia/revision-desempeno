...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">    
                <h2 class="titulo_formulario">Editar Agencia de Riesgos Profesionales</h2><br>  
            <form action="{{ route('arp.update', $arp) }}" method="POST">


                @csrf
                @method('PUT')
                <label for="">Código</label><br>
                <input type="text" name="codigo" value="{{ $arp->codigo }}" required>
                <label for="">Nombre</label><br>
                <input type="text" name="nombre" value="{{ $arp->nombre }}" required>
