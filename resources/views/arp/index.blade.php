...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">    
                <h2 class="titulo_formulario">Administradora de Riesgos Profesionales</h2><br> 
                ...
                <table class="table table-hover table-striped text-center mx-auto">
                    ...
                    <tr>
                        ...
                        <td>{{ $arp->nombre }}</td>
                        <td>
                            <button class="btn btn-warning btn-sm" style="margin-bottom: 5px !important;"><a href="{{ route('arp.edit', $arp->id) }}">Editar</a>
                                </button><br>
                            <form action="{{ route('arp.destroy', $arp) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    @endforeach
                </table><br><br><button><a href="{{ route('arp.create') }}">Crear Fondo de  ARP</a></button>
