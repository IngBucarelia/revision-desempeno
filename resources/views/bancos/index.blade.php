...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="contenido">    
            <h2 class="titulo_formulario">Administrar Bancos</h2><br>
                <table class="table table-hover table-striped text-center mx-auto" >
                    ...
                    <tr>
                        ...
                        <td>{{ $banco->nombre }}</td>
                        <td>
                            <button class="btn btn-warning btn-sm" style="margin-bottom: 5px !important;"><a href="{{ route('bancos.edit', $banco) }}">Editar</a></button><br>
                    ...
                    @endforeach
                </table><br><br><button><a href="{{ route('bancos.create') }}">Crear Banco</a></button>
