...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">    
                <h2 class="titulo_formulario">Administradora de Caja de Compensacion Familiar</h2><br> 
                ...
                <table class="table table-hover table-striped text-center mx-auto">
                    ...
                    <tr>
                        <td>{{ $cajacomp->codigo }}</td>
                        <td>{{ $cajacomp->nombre }}</td>
                        <td>
                            <button class="btn btn-warning btn-sm" style="margin-bottom: 5px !important;"><a href="{{ route('cajacomp.edit', $cajacomp->id) }}">Editar</a></button><br>
                            <form action="{{ route('cajacomp.destroy', $cajacomp) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    @endforeach
                </table><br><br><button><a href="{{ route('cajacomp.create') }}">Crear Caja de Compensacion</a></button>
