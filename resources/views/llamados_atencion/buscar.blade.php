...
<link rel="stylesheet" href="{{ asset('css/estilos.css') }}">
    ...
    <div class="contenedor-principal">
        ...
        <div class="container mt-4 d-flex flex-column align-items-center" style="margin-bottom: 300px">
            <div class="contenido">    
                <h2 class="titulo_formulario">Buscar Llamados y Recordatorios</h2><br> 

                <div class="container">
                    <h2>Buscar Llamados y Recordatorios por Número de Documento</h2>
                    <form action="{{ route('llamados_atencion.buscarllamados') }}" method="GET">
                        @csrf
                        <div class="mb-3">
